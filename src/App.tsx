                ...
                <Suspense fallback={<LoadingFallback />}>
                  <Routes>
                    ...
                    <Route
                      ...
                      element={
                        <AuthGuard>
                          <Suspense fallback={<LoadingFallback componentName="Student Management" />}>
                            <StudentManagement />
                          </Suspense>
                        </AuthGuard>
                      }
                    />
                    {/* Removed Student Check-In route */}
                    <Route
                      path="/notifications"
                      element={
                        <AuthGuard>
                    ...
                    <Route
                      ...
                      element={
                        <AuthGuard>
                          <Suspense fallback={<LoadingFallback componentName="Configuration Billing" />}>
