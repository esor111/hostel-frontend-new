  ...
  return (
    <div className="h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 flex relative">
      ...
      <div className="flex-1 flex flex-col relative z-10 min-w-0">
        ...
        <div className="bg-white/80 backdrop-blur-xl border-b border-white/20 shadow-lg shadow-black/5 px-6 py-4 relative flex-shrink-0">
        ...
        <div className="flex-1 p-4 bg-gradient-to-br from-white/50 via-slate-50/30 to-white/50 backdrop-blur-sm relative overflow-y-auto overflow-x-hidden min-h-0">
