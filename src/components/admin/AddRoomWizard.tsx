...
export const AddRoomWizard = () => {
    ...
    const [formData, setFormData] = useState<RoomFormData>({
        ...
        baseRate: roomData?.monthlyRate || roomData?.rent || roomData?.baseRate || 12000,
        floorNumber: roomData?.floor || roomData?.floorNumber || 1,
            ...
            if (editRoomId && !roomData) {
                try {
                    ...
                    setFormData({
                        ...
                        baseRate: fetchedRoom.monthlyRate || fetchedRoom.rent || fetchedRoom.baseRate || 12000,
                        floorNumber: fetchedRoom.floor || fetchedRoom.floorNumber || 1,
    ...
    const handleSubmit = async () => {
        ...
        try {
            const roomPayload = {
                ...
                floor: formData.floorNumber, // 🔧 FIX: Use 'floor' field name as expected by backend
                status: "ACTIVE",
